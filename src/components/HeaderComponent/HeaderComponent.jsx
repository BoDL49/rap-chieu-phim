            ...
            <div>
                <WrapperHeader>
                    ...
                    <Col span={6}>
                        <WrapperHeaderCart >
                            <WrapperHeaderFilm>
                                <svg style={{ transform: 'rotate(80deg)' }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-ticket-fill" viewBox="0 0 16 16">
