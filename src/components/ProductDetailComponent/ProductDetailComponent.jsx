                    ...
                    <Infor>
                        <WrapperItem>
                            <svg width="30" height="30" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.65102 10.7566C2.62066 9.72627 2.10549 9.21109 1.91379 8.54268C1.72209 7.87428 1.88592 7.16436 2.21357 5.74453L2.40252 4.92575C2.67818 3.73124 2.81601 3.13398 3.22499 2.72499C3.63398 2.31601 4.23123 2.17818 5.42574 1.90252L6.24453 1.71357C7.66436 1.38592 8.37428 1.22209 9.04268 1.41379C9.71109 1.60549 10.2263 2.12066 11.2566 3.15102L12.4764 4.37078C14.269 6.16344 15.1654 7.05976 15.1654 8.17358C15.1654 9.28739 14.269 10.1837 12.4764 11.9764C10.6837 13.769 9.78739 14.6654 8.67358 14.6654C7.55976 14.6654 6.66344 13.769 4.87078 11.9764L3.65102 10.7566Z" stroke="#F3EA28" strokeWidth="1.5" />
                                <circle cx="6.23718" cy="5.91797" r="1.33333" transform="rotate(-45 6.23718 5.91797)" stroke="#F3EA28" strokeWidth="1.5" />
                                <path d="M8.19548 12.332L12.8481 7.6792" stroke="#F3EA28" strokeWidth="1.5" strokeLinecap="round" />
                            </svg>
                            <span>Kinh Dị</span>
                        </WrapperItem>
                        <WrapperItem>
                            <svg width="30" height="30" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="8.4987" cy="7.9987" r="6.66667" stroke="#F3EA28" strokeWidth="1.5" />
                                <path d="M8.5 5.33203V7.9987L10.1667 9.66536" stroke="#F3EA28" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                            <span>100'</span>
                        </WrapperItem>
                        <WrapperItem>
